...
2. Download the prebuilt ISO [here](https://github.com/nideraanth/SampaguitaOS/releases/tag/versionVGA) and put it into a folder called ```SampaguitaOS``` (to be sure).
